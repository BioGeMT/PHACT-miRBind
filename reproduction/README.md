...
| Content | Location |
| --- | --- |
| Final report, variant figures and September study code, including tests | `analyses/supporting/reproduction/` |
| Historical error-review and candidate-weight scripts and tests | `runs/experiments/review-source/` |
| Historical preparation and launch recipes | `archive/legacy-recipes/` |
| September inputs, frozen package, 18 trained runs and analysis outputs | `runs/followup-2026-09-06/` |
| Final figures, tables and reports | `analyses/final/` |
| Published five-model artifacts | `releases/mirbench_v7/` |
...
uv run pytest -q "$PHACT_WORKSPACE/analyses/supporting/reproduction" \
  "$PHACT_WORKSPACE/runs/experiments/review-source/tests"
uv run python "$PHACT_WORKSPACE/analyses/supporting/reproduction/followup_2026_09_06/analysis_2026-09-07/verify_results.py"
uv run python "$PHACT_WORKSPACE/analyses/supporting/reproduction/followup_2026_09_06/analysis_2026-09-07/verify_controls.py"
uv run python "$PHACT_WORKSPACE/analyses/supporting/reproduction/final_analysis/phact_final_qa.py"
```
