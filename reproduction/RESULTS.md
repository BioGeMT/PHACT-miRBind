...
| Fifty-model comparison | `reports/source/reproduction/final_analysis/phact_final_builder.py` | Metric/prediction sources identified in `models/comparisons/overview/all_model_test_leftout_auprc.tsv`; baseline, experiment and Agentomics result directories | Final comparison TSV/CSV/Markdown and figures in `models/comparisons/overview/` |
...
| Fixed positional-control study | `reports/source/reproduction/followup_2026_09_06/{controls,training}/` | P1 cache, fixed control sidecars, conservation cache, frozen package, protocol and original driver hashes | Entire `models/positional-controls/`, especially all 18 checkpoint/result/prediction sets and aggregate tables |
