...
evo_scripts/run_alignment.sh output/annotated_primary output/alignments_primary_conservative 64 "--struct-weight=300 --indel=-200 --indel-opening=-1000"
evo_scripts/run_alignment.sh output/annotated_precursor output/alignments_precursor_conservative 64 "--struct-weight=300 --indel=-200 --indel-opening=-1000 --min-prob=0.005"
