...
python evo_scripts/scrape_parallel.py --input output/manakov_positives_annotated.tsv --output_folder output/precursors --workers 64
...
evo_scripts/./run_alignment.sh output/annotated_precursors output/annotated_precursors_MSA 64
