...
if [[ "$PHACT_MODELS" != *,* && -z "${TARGET_PHACT_MODELS:-}" ]]; then
  DEFAULT_CACHE_DIR=${PHACT_WORKSPACE}/models/caches/phact_cache_${SAFE_MODELS}
  DEFAULT_OUTPUT_DIR=${PHACT_WORKSPACE}/models/new/phact_${SAFE_MODELS}_${PHACT_CHANNEL_MODE}
else
  DEFAULT_CACHE_DIR=${PHACT_WORKSPACE}/models/caches/phact_cache_${SAFE_MODELS}_target_${SAFE_TARGET_MODELS}
  DEFAULT_OUTPUT_DIR=${PHACT_WORKSPACE}/models/new/phact_${SAFE_MODELS}_target_${SAFE_TARGET_MODELS}_${PHACT_CHANNEL_MODE}
fi
